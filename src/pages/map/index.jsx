    ...
    return (
        <>
            <div className="flex items-center justify-center mt-8 ">
                <div className="sm:w-full md:w-full p-2 w-[90%] flex flex-col items-center gap-24 ">
                    <div className="grid grid-cols-4 gap-12  sm:grid-cols-2 md:grid-cols-3">
                        <TestBox />
                        <TestBox />
                        <TestBox />
                        <TestBox />
                    ...
                    <div className=" px-4 flex gap-12 bg-Bsepa-200 rounded-xl">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d103583.05416115272!2d51.367116800000005!3d35.7761024!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f8e03c6f0000001%3A0xf71ac9f4f900d01c!2sQasr%20Garden%20Museum!5e0!3m2!1sen!2s!4v1703184853887!5m2!1sen!2s"
                            className="border-4 overflow-hidden border-white rounded -mt-6 -mb-6" width="600" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        <div className="w-1/2">
