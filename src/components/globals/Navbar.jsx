...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-around sticky top-0 py-6 backdrop-blur-[8px] bg-transparent sm:hidden md:hidden xl:py-2">
            ...
            <div className="sticky top-0 backdrop-blur-[8px] bg-transparent hidden sm:block md:block">
            ...
            <div className="w-full h-screen overflow-hidden ">
                ...
                <div className={`w-full h-screen bg-Bsepa-300 opacity-70 fixed top-0 transition-all duration-700 ${isShowMobileMenu ? "right-0" : "right-[5900px]"}`}></div>
            </div>
        </>
    )
}